...
//The 90 degree rotation of the Zee tile. Checks for conflict while repainting.


public class lZee extends Tetromino {

	int a;

	public lZee(int vx, int vy, Color c, int startX, int startY, int w, int h,
			int t, int or) {
		super(vx, vy, c, startX, startY, w, h, t, or);
		blocks.add(new point(startX, startY - 1, 0, 1, 1));
		blocks.add(new point(startX, startY, 1, 0, 1));
