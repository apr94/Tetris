...
// The 180 degree rotation of the Tee tile. Checks for conflict while repainting.
public class dTee extends Tetromino {

	int a;

	public dTee(int vx, int vy, Color c, int startX, int startY, int w, int h,
			int t, int or) {
