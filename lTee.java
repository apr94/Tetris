...
//The 90 degree rotation of the Tee tile. Checks for conflict while repainting.


public class lTee extends Tetromino {

	int a;

	public lTee(int vx, int vy, Color c, int startX, int startY, int w, int h,
			int t, int or) {
		super(vx, vy, c, startX, startY, w, h, t, or);
		blocks.add(new point(startX, startY - 1, 0, 1, 1));
		blocks.add(new point(startX, startY, 0, 0, 1));
